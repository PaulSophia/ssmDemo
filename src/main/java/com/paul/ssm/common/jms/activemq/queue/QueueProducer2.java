...
import com.paul.ssm.common.constants.ActiveMQConnection;
...
public class QueueProducer2 {
	...
	/** 队列名称 */
	public static final String QUEUE_NAME = "helloMq2";
	...
	public static void main(String[] args) {
		QueueProducer2 producer = new QueueProducer2();
		producer.doSend();
	}
	...
	public void doSend() {
		try {
			...
			for (int i = 0; i < 5; i++) {
				 ...
				 */
				TextMessage message = session.createTextMessage("paul send content test2222:" + i);
